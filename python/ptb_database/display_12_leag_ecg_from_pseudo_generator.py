...
"""
このスクリプト display_12_leag_ecg_from_pseudo_generator.py は
...
以下のファイルを同じフォルダに格納してください
 ...
 ・display_12_leag_ecg_from_pseudo_generator.py   ← 本ファイル
...
load_csv_file_name = 'result_ecg.csv'   # pseudo_ecg_result.csv のデータサイズは C++側で実行したステップ数
