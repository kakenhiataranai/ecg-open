...
このスクリプト output_csv_PTB_all_12_lead_ecg_extracted_sampling_500_hz.py は

上のリンクのデータから全ての549レコード(重複ありなので549人ではない)
の12誘導ECGデータを抽出し
...
【使用法】
 以下のファイルを同じフォルダに格納してください
  ・data_raw.npz
  ・meta.csv
  ・output_csv_PTB_all_12_lead_ecg_extracted_sampling_500_hz.py   ← 本ファイル

   実行すると PTB_control_12_all_ecg_extracted_sampling_500_hz.csv を出力します
"""
...
# .csv に出力
csv_filename = "PTB_all_12_lead_ecg_extracted_sampling_500_hz.csv"
