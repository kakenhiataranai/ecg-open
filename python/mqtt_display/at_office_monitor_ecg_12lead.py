...
dpg.setup_dearpygui()
dpg.show_viewport()
#ss = SubScribe("150.82.92.210", 1883, "pseudo_ecg_topic", "uchiumi", "3214neknek",sec=10, fix=True)
#ss = SubScribe("192.168.100.9", 1883, "pseudo_ecg_topic", "uchiumi", "3214neknek",sec=10, fix=True)
#ss = SubScribe("150.18.225.136", 1883, "pseudo_ecg_topic", "uchiumi", "3214neknek",sec=10, fix=True)
ss = SubScribe("150.18.225.136", 1883, "pseudo_ecg_topic", "uchiumi", "3214neknek",sec=10, fix=True)
dpg.start_dearpygui()
del ss
dpg.destroy_context()
