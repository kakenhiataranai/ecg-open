...
void ecg_signals::generate_12_lead_ecg_signals_one_cycle(std::vector<std::vector<std::vector<double>>>& ecg_result) {
...
int ecg_signals::get_mcsharry_variable_num() const {
 return mcsharry_variable_num;
}
